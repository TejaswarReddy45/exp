...
$sql_check = "SELECT * FROM external2_marks WHERE student_id = ? AND semester = ?";
...
if ($result_check->num_rows > 0) {
    ...
    $sql_update = "UPDATE external2_marks SET 
    ...
    $sql_insert = "INSERT INTO external2_marks (student_id, semester, sub1, sub2, sub3, sub4, sub5, sub6, sub7, sub8, sub9) 
                   VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
