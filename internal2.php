...
$sql_check = "SELECT * FROM internal2_marks WHERE student_id = ? AND semester = ?";
...
if ($result_check->num_rows > 0) {
    ...
    $sql_update = "UPDATE internal2_marks SET 
        sub1 = ?, sub2 = ?, sub3 = ?, sub4 = ?, sub5 = ?, 
        sub6 = ?, sub7 = ?, sub8 = ?, sub9 = ?
        WHERE student_id = ? AND semester = ?";
    
    $stmt_update = $conn->prepare($sql_update);
    $stmt_update->bind_param("sssssssssss", $sub1, $sub2, $sub3, $sub4, $sub5, 
        $sub6, $sub7, $sub8, $sub9, $student_id, $semester);
    ...
    $sql_insert = "INSERT INTO internal2_marks (student_id, semester, sub1, sub2, sub3, sub4, sub5, sub6, sub7, sub8, sub9) 
                   VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    
    $stmt_insert = $conn->prepare($sql_insert);
    $stmt_insert->bind_param("sssssssssss", $student_id, $semester, $sub1, $sub2, $sub3, $sub4, $sub5, $sub6, $sub7, $sub8, $sub9);
