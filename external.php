...
$sql_check = "SELECT * FROM external_marks WHERE student_id = ? AND semester = ?";
...
if ($result_check->num_rows > 0) {
    ...
    $sql_update = "UPDATE external_marks SET 
    ...
    $stmt_update->bind_param("sssssssssssss", $sub1, $sub2, $sub3, $sub4, $sub5, 
        $sub6, $sub7, $sub8, $sub9, $sub10, $sub11, $student_id, $semester);
    ...
    $sql_insert = "INSERT INTO external_marks (student_id, semester, sub1, sub2, sub3, sub4, sub5, sub6, sub7, sub8, sub9, sub10, sub11) 
                   VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
